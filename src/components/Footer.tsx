          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a
                ...
                className="group p-3 bg-gray-800 hover:bg-blue-500 rounded-full transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 bg-gray-800 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 rounded-full transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 bg-gray-800 hover:bg-green-500 rounded-full transition-all duration-300 hover:scale-110"
